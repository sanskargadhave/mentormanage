...
const {GetAttendanceByLectureId,MakeAttendanceReport,GetTodayAttendance}=require("../controllers/AttendanceControler");
...
router.get("/api/get-today-attendance",GetTodayAttendance);
