    ...
    const html = `
      <html>
        ...
        <body>
          ...
          <p>
            <b>Course:</b> ${testdetails.course}
            <b>Year:</b> ${testdetails.year}
            <b>Division:</b> ${testdetails.division}
          </p>
          ...
          <p><b>Teacher Name:</b> Prof. ${teacher?.teacherid?.personaldetails?.name || "Unknown"}</p>

          <p>
            <b>Counts:</b>

            <b class="bolds">Total :</b> ${counts.countpresent + counts.countabsent}

            <b class="bolds">Present:</b> ${counts.countpresent}

            <b class="bolds">Absent:</b> ${counts.countabsent}

            <b class="bolds">Pass:</b> ${counts.countpass}

            <b class="bolds">Fail:</b> ${counts.countfail}
